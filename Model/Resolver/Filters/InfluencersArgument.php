...
/**
 * Class InfluencersArgument
 * @package SajidPatel\SocialInfluencer\Model\Resolver\Filters
 */
class InfluencersArgument implements FieldEntityAttributesInterface
{
    /** @var ConfigInterface */
    private $config;
    ...
    public function getEntityAttributes(): array
    {
        $fields = [];
        /** @var Field $field */
        foreach ($this->config->getConfigElement('Influencer')->getFields() as $field) {
